FormPlanProdChapCab = Ext.extend(PanelFormCabeceraAbm, {
  
  constructor : function(config) {
    FormPlanProdChapCab.superclass.constructor.call(this, Ext.apply({
  		id: 'formPlanProdChapId',
      frame: true,
  		prefijo: 'formPlanProdChapId',
      region: 'center',
  		nombreElementoId: 'plPrChapCabId',
  	  urlAgregado: '/produccion/svc/conector/plPrChapCab.php/inserta',
  	  urlModificacion: '/produccion/svc/conector/plPrChapCab.php/actualiza',
  	  urlBorrado: '/produccion/svc/conector/plPrChapCab.php/borra',
  		items: [
        {xtype: 'hidden', name: 'plPrChapCabId', itemId: 'plPrChapCabId', id: 'plPrChapCabId'},
        ...
        {fieldLabel: 'Planilla vacía', xtype: 'button', text: 'Imprimir',  
                listeners: {
                  ...
                  click: function(boton, evento){
                    ...
                    Ext.Ajax.request({
                    url:  '/produccion/svc/conector/plPrChapCab.php/planillaVacia',
                    method: 'POST',
                    params: { 
  	  ...
  	  pueblaDatosEnForm : function(record){
         this.getComponent('plPrChapCabId').setValue(record.id);
//         this.getComponent('comboEmpleados').setValue(record.get('empleadoApellido') + ', ' + record.get('empleadoNombre'));
  	   ...
  	   pueblaFormEnRegistro : function(record){
  		   record.data['plPrChapCabId']=  this.getComponent('plPrChapCabId').getValue();
