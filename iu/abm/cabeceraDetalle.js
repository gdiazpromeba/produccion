 ...
 * @return
 */
function cabeceraDetalle(grillaDetalle, formDetalle, grillaCabecera, formCabecera) {
  ...
  formDetalle.on('datos del formulario cabecera cambiaron',
      function() {
        ...
        storeDetalle.setBaseParam('valorIdPadre', formDetalle.getComponent(formDetalle.prefijo +  'valorIdPadre').getValue());
        storeDetalle.reload();
    });
