BusquedaBancos = Ext.extend(Ext.form.FormPanel, {
	constructor : function(config) {
		BusquedaBancos.superclass.constructor.call(this, Ext.apply({
      region: 'west',
      frame: true,
      width: 340,
      items: [
        {fieldLabel: 'Nombre (o parte) del banco', xtype: 'textfield', itemId: 'bancoNombre', allowBlank: true, width: 150}
      ],
      buttons: [
      ...
      getParamsBusqueda: function(){
        ...
        this.agregaClaveValor(resultado, 'nombreOParte', this.getComponent('bancoNombre').getValue());
        return resultado;
      },
...
Ext.reg('busquedabancos', BusquedaBancos);