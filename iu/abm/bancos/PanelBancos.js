PanelBancos = Ext.extend(Ext.Panel, {
  constructor : function(config) {
    PanelBancos.superclass.constructor.call(this, Ext.apply({
      region: 'center',
      layout: 'fit',
      listeners: {
        render: function(me) {
  ...
  creaCabecera :  function(me){
    me.panForm=new FormBancos({
      id: 'Formulario de Áreas Funcionales',	
      region: 'center'
    });
    me.panBusqueda=new  BusquedaBancos({
      id: 'busquedaBancos', 	
      region: 'west',
      width: 400,
    });
