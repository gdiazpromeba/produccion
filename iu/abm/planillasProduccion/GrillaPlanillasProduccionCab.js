GrillaPlanillasProduccionCab = Ext.extend(Ext.grid.GridPanel, {
	constructor : function(config) {
		GrillaPlanillasProduccionCab.superclass.constructor.call(this, Ext.apply({
      region: 'center',
			store : new Ext.data.Store({
				proxy : new Ext.data.HttpProxy({
					url : '/produccion/svc/conector/planillasProduccionCabecera.php/selecciona'
        }),
        ...
        autoLoad: true,
			...
			columns : [
        {header : 'id', dataIndex : 'planProdCabId', hidden : true},
