FormPlanillasProduccionCab = Ext.extend(PanelFormCabeceraAbm, {
  
  constructor : function(config) {
    FormPlanillasProduccionCab.superclass.constructor.call(this, Ext.apply({
  		id: 'formPlanillasProduccionCab',
      frame: true,
  		prefijo: 'formPlanillasProduccionCab',
      region: 'center',
  		nombreElementoId: 'planProdCabId',
  	  urlAgregado: '/produccion/svc/conector/planillasProduccionCabecera.php/inserta',
  	  urlModificacion: '/produccion/svc/conector/planillasProduccionCabecera.php/actualiza',
  	  urlBorrado: '/produccion/svc/conector/planillasProduccionCabecera.php/borra',
  		items: [
        {xtype: 'hidden', name: 'planProdCabId', itemId: 'planProdCabId', id: 'planProdCabId'},
        ...
        {fieldLabel: 'Planilla vacía', xtype: 'button', text: 'Imprimir',  
                listeners: {
                  ...
                  click: function(boton, evento){
                    ...
                    Ext.Ajax.request({
                    url:  '/produccion/svc/conector/planillasProduccionCabecera.php/planillaVacia',
                    method: 'POST',
                    params: { 
  	  ...
  	  pueblaDatosEnForm : function(record){
         this.getComponent('planProdCabId').setValue(record.id);
//         this.getComponent('comboEmpleados').setValue(record.get('empleadoApellido') + ', ' + record.get('empleadoNombre'));
  	   ...
  	   pueblaFormEnRegistro : function(record){
  		   record.data['planProdCabId']=  this.getComponent('planProdCabId').getValue();
