GrillaOrdenesProduccionCab = Ext.extend(Ext.grid.GridPanel, {
	constructor : function(config) {
		GrillaOrdenesProduccionCab.superclass.constructor.call(this, Ext.apply({
			store : new Ext.data.Store({
				proxy : new Ext.data.HttpProxy({
					url : '/produccion/svc/conector/ordenProdCabecera.php/selecciona'
        }),
        ...
        autoLoad: true,
			...
			columns : [
        {header : 'id', dataIndex : 'ordProdCabId', hidden : true},
