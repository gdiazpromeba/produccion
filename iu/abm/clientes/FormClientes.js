FormClientes = Ext.extend(PanelFormCabeceraAbm, {
  
  constructor : function(config) {
    FormClientes.superclass.constructor.call(this, Ext.apply({
    	title: 'ABM Clientes',
    	prefijo: 'ABMClientes',
    	region: 'center',
      ...
      urlBorrado: '/produccion/svc/conector/clientes.php/borra',    
    	items: [
          ...
          {fieldLabel: 'Condicion IVA', xtype: 'combo', id: 'cmbCondicionIva', itemId: 'condicionIva',  name: 'cmbCondicionIva', allowBlank: true, 
       ...
       pueblaDatosEnForm : function(record){
         ...
         this.getComponent('condicionIva').setValue(record.get('condicionIva'));
