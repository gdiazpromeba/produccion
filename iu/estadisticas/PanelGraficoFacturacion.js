PanelGraficoFacturacion = Ext.extend(Ext.Panel, {
  ...
  constructor : function(config) {
    ...
    var storeMontos= new Ext.data.Store({
      ...
      proxy : new Ext.data.HttpProxy({
        ...
        url : '/produccion/svc/conector/estadisticas.php/facturacion'
      ...
      reader : new Ext.data.JsonReader({
          ...
          fields : [
            ...
            {name : 'montoMenosNc', type : 'float', allowBlank : false},
    ...
    PanelGraficoFacturacion.superclass.constructor.call(this, Ext.apply({
        iconCls:'chart',
          ...
          {xtype: 'panel', itemId: 'superior', height: 100, layout: 'hbox', region: 'north', 
               ...
               {xtype: 'grid', flex: 2, frame: true,
                  colModel: new Ext.grid.ColumnModel({
                    columns: [
                      ...
                      {header: 'Monto Facturado', width: 200, renderer: Ext.util.Format.usMoney, align: 'right', dataIndex: 'montoMenosNc'},
           ...
           {xtype: 'columnchart', region: 'center',  itemId: 'grafico',
            ...
            tipRenderer : function(chart, record, index, series){
                if(series.yField == 'montoMenosNc'){
                    return Ext.util.Format.number(record.data.montoMenosNc, '0,0') + ' facturado en ' + record.data.mes;
            ...
            series: [{
                type: 'line', displayName: 'Pedido', yField: 'montoMenosNc',
                style: {mode: 'stretch', color:0x99BBE8}
            },{
                type: 'line', displayName: 'Remitido', yField: 'montoMenosInflacion',
